...
let searchInput = document.querySelector('.course_input');
let searchButton = document.querySelector('.course_button');
...
/////////// Вывод данных в HTML
function addCoursesToHtml(course) {
    ...
    course.forEach(el => {
        ...
        technologiesList.appendChild(technoContainer);
    });
}
function showModal(myTechnology, myTechnoContainer) {
    modal.innerHTML = '';
...
let modalContacts2 = document.querySelector('.modal_contacts');
let modalLink2 = document.querySelector('.contacts_link');
let modalCloseContacts2 = document.querySelector('.contactsClose');
